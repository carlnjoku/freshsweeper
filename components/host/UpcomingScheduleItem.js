...
import CleaningDateDisplay from '../../utils/CleaningDateDisplay';
...
<View>
      ...
      <View style={styles.container}>
            <View style={styles.date_time}>
              ...
              <Text style={styles.date}>{CleaningDateDisplay(item.schedule.cleaning_date, item?.schedule?.cleaning_time)}{moment(item.schedule.cleaning_date).format('ddd MMM DD')}</Text>
