    ...
    <View style={styles.jobCard}>
      <View style={styles.container}>
        ...
        <View style={styles.task_details}>
          ...
          <Text>
            Message: Your property at [Property Address] has been scheduled for cleaning on [Cleaning Date] at [Cleaning Time]. 
            [Cleaner Name] has been assigned to this task. Track progress in your dashboard.
          </Text>
...
export default AutoScheduleItem;
