...
const ApplicationListItem = ({item, currentUser }) => {
    ...
    <View>
                ...
                >
                    <View style={{flexDirection: 'row', paddingVertical:5}}>
                      ...
                      <View style={{flex: 0.9}}>
                          <Text bold  style={{marginLeft:10, fontSize:15, color:COLORS.gray}}>{item.schedule.apartment_name}</Text>
                          <Text style={{marginLeft:10, fontSize:13, color:COLORS.gray}}>{item.schedule.address} </Text>
                          ...
                          <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginTop:2}}> 
                            <ChipWithBackground label={item.schedule.cleaning_date} backgroundColor={COLORS.primary_light_1} color={COLORS.gray}/> 
