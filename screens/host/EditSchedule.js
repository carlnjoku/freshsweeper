...
const EditSchedule = ({close_modal, schedule, onSave, onClose}) => {
  ...
  const {formData, setFormData, setModalEVisible, setModalVisible, modalEVisible, resetFormData, selectedSchedule } = useBookingContext();
